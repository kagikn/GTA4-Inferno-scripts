...
namespace Inferno.Scripts
{
    //市民暴走運転
    //クラス名意味不明
    public class CivilianCrazyDriving : Script
    {
        ...
        public CivilianCrazyDriving()
        {
            ...
            this.Tick += new EventHandler(this.CivilianCrazyDriving_Tick);
            KeyDown += new GTA.KeyEventHandler(CivilianCrazyDriving_KeyDown);
            allV = Cacher.GetVehicles(Player.Character.Position, 100.0f);
        }
        private void CivilianCrazyDriving_Tick(object sender, EventArgs e)
        {
        ...
        void CivilianCrazyDriving_KeyDown(object sender, GTA.KeyEventArgs e)
        {
