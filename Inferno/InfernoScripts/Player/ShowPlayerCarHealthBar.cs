...
namespace Inferno.Scripts{
    ...
    public class TextureDrawingExample : Script
    {
        ...
        public TextureDrawingExample()
        {
            ...
            PerFrameDrawing += new GTA.GraphicsEventHandler(TextureDrawingPerFrameDrawing);
        }

        private void TextureDrawingPerFrameDrawing(System.Object sender, GTA.GraphicsEventArgs e)
        {
