...
{
    //死亡距離
    public class ShowDistanceDuringDeath : Script
    {
   ...
   //     Color screenBoxColor;
        ...
        public ShowDistanceDuringDeath()
        {
            ...
            this.PerFrameDrawing += new GraphicsEventHandler(this._PerFrameDrawing);
        ...
        private void _PerFrameDrawing(object sender, GraphicsEventArgs e)
        {
            try
            {
                if (!player.isAlive)
