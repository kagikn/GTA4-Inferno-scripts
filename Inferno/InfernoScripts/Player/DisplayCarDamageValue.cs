...
namespace Inferno.Scripts
{
    ...
    public class DisplayCarDamage : Script
    {
     ...
     public class NewCarDamage : Script
    {
        ...
        DisplayCarDamage[] DAM;
        Random rnd;


        public NewCarDamage()
        {
            DAM = new DisplayCarDamage[50];
            Engine = 0;
            Petrol = 1;
            Body = 2;
            rnd = new Random();
            ...
            for (int i = 0; i < 50; i++)
            {
                DAM[i] = new DisplayCarDamage(rnd.Next());
            }
       ...
       unsafe private void Bombat_Tick(object sender, EventArgs e)
        ...
        unsafe private void KyoriPerFrameDrawing(object sender, GraphicsEventArgs e)
        {
