   ...
   // パルプンテ：ブラックアウトで動く
    public class BlackOut : Script
    {
        ...
        public BlackOut()
        {
            ...
            PerFrameDrawing += new GTA.GraphicsEventHandler(TextureDrawingExamplePerFrameDrawing);
        ...
        private void TextureDrawingExamplePerFrameDrawing(System.Object sender, GTA.GraphicsEventArgs e)
        {
