...
namespace Inferno.Scripts
{
    ...
    public class SuperRpg : Script
    {
        ...
        public SuperRpg()
        {
            ...
            BindScriptCommand("FTB", new ScriptCommandDelegate(BlowPlayer));
            ...
            this.Tick += new EventHandler(this.SuperRpgTick);
            KeyDown += new GTA.KeyEventHandler(SuperRpgKeyDown);

        }
        private void BlowPlayer(GTA.Script sender, GTA.ObjectCollection Parameter)
        {
            if (AllF)
            {
        ...
        private void SuperRpgTick(object sender, EventArgs e)
        {
            if (!AllF) { return; }
        ...
        void SuperRpgKeyDown(object sender, GTA.KeyEventArgs e)
        {
