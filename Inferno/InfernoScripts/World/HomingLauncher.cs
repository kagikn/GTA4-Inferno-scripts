...
{
    //ホーミングRPG
    public class HomingLauncher : Script
    {
        public GTA.Object o;
        public Ped p;
    ...
    public class Horming : Script
    {
        ...
        public Horming()
        {
            ...
            ExternalFlag = false;
            Interval = 500;
            RT = new HomingLauncher[100];
            for (int i = 0; i < RT.Length; i++)
            {
                RT[i] = new HomingLauncher();
            }
            ...
            this.PerFrameDrawing += new GraphicsEventHandler(this.KyoriPerFrameDrawing);
        }
        ...
        //距離バージョン
        private Ped GetDistanceToTargetPed(GTA.Object Obj)
        {
            Ped[] Peds;
            Vector3 Po, P, D;
            float MinDist = 30.0f;
        ...
        //角度バージョン
        private Ped GetTargetPedAngle(GTA.Object Obj)
        {
            Ped[] Peds;
        ...
        private void KyoriPerFrameDrawing(object sender, GraphicsEventArgs e)
        {
